...
DATASETS = [
    ...
    # v2 版本给 assistant 答案补上了空 <think> 块，
    # 让 enable_thinking=False 的硬开关在推理时稳定生效
    ROOT / "data" / "train" / "persona_train_aug_v2.jsonl",

    ROOT / "data" / "train" / "tools_train_v2.jsonl",

    ROOT / "data" / "train" / "think_train_v2.jsonl"
...
OUTPUT = ROOT / "models" / "adapters" / "output-qwen3-1.7-persona-v6"
